CLASS zcl_flight_service DEFINITION
  ...
  PUBLIC SECTION.
    ...
    METHODS get_flights
      ...
      CHANGING
        ct_entityset            TYPE zcl_zflight_service_mpc=>tt_flight.
...
CLASS zcl_flight_service IMPLEMENTATION.
  ...
  METHOD get_flights.
    ...
    io_tech_request_context->get_converted_source_keys( IMPORTING es_key_values = ls_keys ).
